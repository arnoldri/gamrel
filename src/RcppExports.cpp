...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(lprior_sbt_c(eta, gamma1, thetavec1, vvec1, alpha1, beta1, phi1, gamma2, thetavec2, vvec2, alpha2, beta2, phi2, nu, a1, a2, b1, b2, f11, f12, f21, f22));
    return rcpp_result_gen;
END_RCPP
}
// lprior_mbt_c
