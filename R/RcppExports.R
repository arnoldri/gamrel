...
#' 
#' @export
lprior_cvx_c <- function(eta, tau, gamma1, thetavec1, vvec1, alpha1, beta1, phi1, gamma2, thetavec2, vvec2, alpha2, beta2, phi2, nu, c1, c2, a1, a2, b1, b2, f1, f2) {
    .Call(`_gamrel_lprior_cvx_c`, eta, tau, gamma1, thetavec1, vvec1, alpha1, beta1, phi1, gamma2, thetavec2, vvec2, alpha2, beta2, phi2, nu, c1, c2, a1, a2, b1, b2, f1, f2)
}
...
#' 
#' @export
lambda_func_cvx_c <- function(tvec, lambda0, tau, thetavec1, wvec1, thetavec2, wvec2) {
    .Call(`_gamrel_lambda_func_cvx_c`, tvec, lambda0, tau, thetavec1, wvec1, thetavec2, wvec2)
}
